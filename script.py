...
class AlienBot:
  ...
  # Define .greet() below:
  def greet(self):
    self.name = input("Hello friend, what is your name? \n")
    will_help = input(f"Hi {self.name}. I'm Siggi. I am not from this planet. Will you help me learn about your planet? \n")
  ...
  def describe_planet_intent(self):
    # responses for describe_planet_intent
    responses = (
